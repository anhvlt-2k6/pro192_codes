...
public class MyFurniture implements IFurniture {
    ...
    public void f2(List<Furniture> t) {
        Comparator cmp = new SortByName();
        ArrayList<Integer> index = new ArrayList<Integer>();
        ArrayList<Furniture> ls_match = new ArrayList<Furniture>();
    ...
    public void f3(List<Furniture> t) {
        ...
        double averagePrice = totalPrice / index; 
        
        for (Furniture y : t) {
            if (y.getPrice() > averagePrice || Character.isDigit(y.getName().toCharArray()[0])) {
